...
SRC_FILES	=	main.c startup.c parser.c tokenization.c shutdown.c execute.c pathing.c mario.c files.c delim.c execute1.c parser_quotes.c parser_tokens.c parser_vars.c luigi.c token_parse.c token_quotes.c signals.c
